...
public class TelaThreadPilha extends JDialog {
...
private JPanel jpanel = new JPanel(new GridBagLayout());/*Painel de Conponentes*/
	...
	private JLabel descicaoHora2 = new JLabel("E-mail");
	...
	public TelaThreadPilha() { /*Construtor - Executa o que tiver dentro no momento da abertura ou execução*/
		/*Configuracoes iniciais da tela*/
		setTitle("Geração em Lote");
		...
		jButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {/*Executa click do botao*/
				...
				for (int qtd = 0; qtd < 100; qtd++) {/*Simulando 100 envios em massa*/
					...
					objetoFilaThread.setEmail(mostraTempo2.getText() + " - " + qtd);
